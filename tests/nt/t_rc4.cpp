...
TEST(rc4_test, SWAP_error_127) {
    ...
    EXPECT_THROW(
        rc.compute(key_2, text_2, hashtext_FALSE_127, swap_FALSE_127),
        std::runtime_error);
